document.addEventListener('DOMContentLoaded', () => {
  ...
  const theTetrominoes = [jTetromino, sTetromino, zTetromino, lTetromino, tTetromino, oTetromino, iTetromino]
  ...
  const upNextTetrominoes = [
    ...
    [1, displayWidth+1, displayWidth, displayWidth*2], //zTetromino
